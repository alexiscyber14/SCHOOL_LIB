...
module CreateRental
  ...
  def create_rental
    ...
    @people.each_with_index do |person, index|
      print "#{index}) [#{person['role'].capitalize}] Name: #{person['name'].capitalize},"
      puts " ID: #{person['id']}, Age: #{person['age']}"
    end
    ...
    create_rental_entry(selected_data)

    puts 'Rental created successfully!'
    puts "\n"
  end

  def create_rental_entry(selected_data)
